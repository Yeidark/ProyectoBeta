            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="./controlador?accion=home"><i class="fas fa-home"></i> Productos<span class="sr-only"></span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./controlador?accion=home"><i class="fas fa-plus-circle"></i>ofertas</a>
                    </li>                   
                    <li class="nav-item">
                        <a class="nav-link" href="controlador?accion=Carrito"><i class="fas fa-cart-plus">(<label style="color: aqua">${contador}</label>)</i>Carrito</a>
                    </li> 
                        ...
                        <div class="form-group">
                            <div class="card">
                                ...
                                <div class="card-body text-center d-flex">
                                    ...
                                    <img src="controladorImg?id=${pro.getFoto()}" width="200" height="170">
                                </div>
